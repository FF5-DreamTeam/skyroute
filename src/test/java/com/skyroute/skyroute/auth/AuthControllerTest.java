...
public class AuthControllerTest {
        ...
        void register_shouldReturnConflict_whenEmailAlreadyExists() throws Exception {
                ...
                when(authService.register(any(UserRequest.class)))
                                .thenThrow(new EmailAlreadyExistsException(
                                                "Email already exists: john.doe@example.com"));
        ...
        @Test
        void forgotPassword_shouldReturnSuccessResponse_whenValidEmail() throws Exception {
                ForgotPasswordRequest request = createForgotPasswordRequest();
                PasswordResetResponse response = createPasswordResetResponse(
        ...
        @Test
        void forgotPassword_shouldReturnBadRequest_whenEmptyEmail() throws Exception {
        ...
        @Test
        void resetPassword_shouldReturnSuccessResponse_whenValidToken() throws Exception {
                ResetPasswordRequest request = createResetPasswordRequest();
                PasswordResetResponse response = createPasswordResetResponse("Password has been successfully reset",
                                true);
        ...
        @Test
        void resetPassword_shouldReturnBadRequest_whenInvalidRequest() throws Exception {
        ...
        @Test
        void resetPassword_shouldReturnBadRequest_whenShortPassword() throws Exception {
                ResetPasswordRequest invalidRequest = new ResetPasswordRequest("valid-token", "123");
        ...
        @Test
        void resetPassword_shouldReturnInternalServerError_whenInvalidToken() throws Exception {
                ResetPasswordRequest request = createResetPasswordRequest();
        ...
        @Test
        void resetPassword_shouldReturnInternalServerError_whenExpiredToken() throws Exception {
                ResetPasswordRequest request = createResetPasswordRequest();
                when(authService.resetPassword(any(ResetPasswordRequest.class)))
        ...
        @Test
        void passwordResetEndpoints_shouldBeAccessibleWithoutAuthentication() throws Exception {
                ForgotPasswordRequest forgotRequest = createForgotPasswordRequest();
                PasswordResetResponse forgotResponse = createPasswordResetResponse(
                                "Password reset instructions have been sent to your email", true);
                when(authService.forgotPassword(any(ForgotPasswordRequest.class))).thenReturn(forgotResponse);
        ...
        private ForgotPasswordRequest createForgotPasswordRequest() {
                return new ForgotPasswordRequest("test@example.com");
        }

        private ResetPasswordRequest createResetPasswordRequest() {
                return new ResetPasswordRequest("valid-reset-token", "newpassword123");
        }

        private PasswordResetResponse createPasswordResetResponse(String message, boolean success) {
                return new PasswordResetResponse(message, success);
        }
}
