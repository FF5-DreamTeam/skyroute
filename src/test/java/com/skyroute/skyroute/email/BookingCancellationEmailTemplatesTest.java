...
@ActiveProfiles("test")
class BookingCancellationEmailTemplatesTest {

    @Test
    void getSubject_shouldReturnCorrectSubject() {
        String subject = BookingCancellationEmailTemplates.getSubject();

        assertEquals("SkyRoute - Booking Cancelled", subject);
    }
    ...
    void getPlainText_shouldReturnFormattedPlainText() {
        ...
        assertTrue(plainText.contains("Your booking has been cancelled"));
        ...
        assertTrue(plainText.contains("refund will be processed within 5-7 business days"));
    ...
    void getHtml_shouldReturnFormattedHtml() {
        ...
        String html = BookingCancellationEmailTemplates.getHtml(
                firstName, lastName, bookingNumber, flightNumber,
                departureTime, arrivalTime, departureCity, arrivalCity, totalPrice);
        ...
        assertTrue(html.contains("Your booking has been"));
        ...
        assertTrue(html.contains("✕ CANCELLED"));
        assertTrue(html.contains("Refund Information"));
        assertTrue(html.contains("View Your Bookings"));
        assertTrue(html.contains("http://localhost:3000/login/"));
        assertTrue(html.contains("We hope to serve you again soon!"));
    }
